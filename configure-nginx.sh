...
sudo curl https://raw.githubusercontent.com/kmencarnacao/HW6_scripts/main/configure-nginx.sh | sudo tee -a /etc/nginx/sites-available/default
...
sudo git clone https://github.com/kmencarnacao/HW6_website.git
